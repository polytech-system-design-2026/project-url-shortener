...
PR `develop → main`, reviewer `vladefr97`, сообщение в чат: «project-url-shortener, ник, этап 4, PR готов». Подробно — в [README](../README.md#как-сдавать), раздел «Как сдавать».
